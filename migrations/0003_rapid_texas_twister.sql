...
ALTER TABLE "files" ALTER COLUMN "in_trash" SET DATA TYPE text;--> statement-breakpoint
ALTER TABLE "files" ALTER COLUMN "banner_url" SET DATA TYPE text;--> statement-breakpoint
...
ALTER TABLE "folders" ALTER COLUMN "icon_id" SET DATA TYPE text;--> statement-breakpoint
ALTER TABLE "folders" ALTER COLUMN "in_trash" SET DATA TYPE text;--> statement-breakpoint
ALTER TABLE "folders" ALTER COLUMN "banner_url" SET DATA TYPE text;--> statement-breakpoint
...
ALTER TABLE "workspaces" ALTER COLUMN "icon_id" SET DATA TYPE text;--> statement-breakpoint
ALTER TABLE "workspaces" ALTER COLUMN "in_trash" SET DATA TYPE text;--> statement-breakpoint
ALTER TABLE "workspaces" ALTER COLUMN "logo" SET DATA TYPE text;--> statement-breakpoint
ALTER TABLE "workspaces" ALTER COLUMN "banner_url" SET DATA TYPE text;--> statement-breakpoint
